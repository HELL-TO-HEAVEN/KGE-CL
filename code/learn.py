...
parser.add_argument('--hidden_size', default=2048, type=int, help="hidden_size")
parser.add_argument('--a_h', default=0, type=float, help="alpha_h")
parser.add_argument('--a_t', default=0, type=float, help="alpha_t")
parser.add_argument('--a_hr', default=0, type=float, help="alpha_hr")
parser.add_argument('--a_tr', default=0, type=float, help="alpha_tr")
...
optimizer = KBCOptimizer(
    args.model, model, regularizer, optim_method, args.batch_size,
    args.rank, args.temperature, args.hidden_size, args.a_h, args.a_t, args.a_hr, args. a_tr
)
